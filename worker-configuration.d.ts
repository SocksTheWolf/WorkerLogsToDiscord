...
// Runtime types generated with workerd@1.20251125.0 2025-01-17 
...
type Fetcher<T extends Rpc.EntrypointBranded | undefined = undefined, Reserved extends string = never> = (T extends Rpc.EntrypointBranded ? Rpc.Provider<T, Reserved | "fetch" | "connect"> : unknown) & {
    postWarning(serviceName: string, msg: string, logHook: string | null): unknown;
    postError(serviceName: string, msg: string, logHook: string | null): unknown;
    postLog(serviceName: string, msg: string, logHook: string | null): unknown;
